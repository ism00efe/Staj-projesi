...
from payment_assistant.sanitization import (
    CARD,
    EMAIL,
    IP,
    PHONE,
...
def test_valid_tckn_masked():
    # 10000000146 is a checksum-valid test TCKN.
    out = sanitize("national_id 10000000146 ok")
    assert TCKN in out and "10000000146" not in out
