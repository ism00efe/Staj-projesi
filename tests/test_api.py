...
def test_health_reports_kb_size_and_the_upload_limit():
    body = _client(max_upload_bytes=1234).get("/api/health").json()
    assert body == {"status": "ok", "knowledge_base_size": 7, "max_upload_bytes": 1234}
