...
from payment_assistant.security.guard import REFUSAL_MESSAGE, inspect_query
...
# --- refusal message -------------------------------------------------------------
def test_refusal_message_is_turkish_and_nonempty():
    assert REFUSAL_MESSAGE and "güvenlik" in REFUSAL_MESSAGE.lower()
